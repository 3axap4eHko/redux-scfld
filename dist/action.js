...
var actionTemplate = (0, _lodash.template)(_fs2.default.readFileSync(_config.loadedConfig.actionTemplatePath), _templateOptions2.default);
var indexTemplate = (0, _lodash.template)(_fs2.default.readFileSync(_config.loadedConfig.actionsIndexTemplatePath), _templateOptions2.default);
...
function generateActionsIndex(entities) {
    (0, _utils.mkDir)(_config.loadedConfig.actionsPath);
    var content = indexTemplate({ entities: entities });
    _fs2.default.writeFileSync(_path2.default.join(_config.loadedConfig.actionsPath, 'index.js'), content);
    return entities;
}